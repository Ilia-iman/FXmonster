...
class WC_Braintree_Controller_Checkout extends WC_Braintree_Controller_Frontend {
	...
	public function after_checkout_validation( $data, $errors ) {
		if ( $errors->get_error_message( 'required-field' ) ) {
			wc_add_notice(
				apply_filters(
					'wc_braintree_after_checkout_validation_notice',
					sprintf(
						__( 'Some required fields were missing. Please click %1$shere%2$s to complete your payment.', 'woo-payment-gateway' ),
						'<a href="' .
